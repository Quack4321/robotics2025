...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2884.3093530473066; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2500.8421627778166; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2318.144909886995; // x position of the perpendicular encoder (in tick units)
    }
